      ...
      <div class="sign-up">
        <div class="sign-up-body">
          <form class="sign-up-form">
            <div v-if="!isEmployer" id="username" class="form-group">
            ...
            <div v-else id="companyName" class="form-group">
              <label class="input validator">
                <svg class="h-[1em] opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <g stroke-linejoin="round" stroke-linecap="round" stroke-width="2.5" fill="none" stroke="currentColor">
        ...
        <div class="sign-up-bottom">
          ...
          <div>
            <p class="text-sm">
              ...
              <NuxtLink :to="isEmployer ? '/auth/EmployerSignIn' : '/auth/SignIn'" class="text-blue-500 hover:underline">Log in</NuxtLink>
            </p>
          ...
          <div class="flex flex-col items-left">
            <p class="mb-2">
              <span v-if="isEmployer">Want to sign up as a job seeker?</span>
            ...
            <button
              ...
              type="button"
            >
              <span v-if="isEmployer">Switch to Job Seeker Sign Up</span>
              <span v-else>Switch to Employer Sign Up</span>
            </button>
          </div>
        </div>
      </div>
...
#sign-up-page {
  @apply flex justify-center min-h-fit;
}
.sign-up {
...
.sign-up-bottom {
  @apply flex flex-col gap-4 mt-92;
}
.agreement-msg {
